...
def get_product_list():
    ...
    if frappe.request and frappe.request.data:
        try:
            ...
            # Ignore if body is not valid JSON or not a dict
            pass

    base_url = get_url()  # Base URL for fallback
    ...
    for prod in products:
        ...
        prod["discounted_price"] = fmt_money(prod["discounted_price"]) if prod.get("discounted_price") else None
